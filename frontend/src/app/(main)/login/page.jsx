        ...
        <div className="grid gap-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input type="email" id="email" name="email" className=" border border-gray-800 py-2.5 sm:py-3 px-4 block w-full border-black-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-30 disabled:pointer-events-none" required aria-describedby="email-error" />
